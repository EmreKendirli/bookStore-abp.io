...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b2ca17c7-b810-4e68-b7f4-0fc95edda9b4
```

> `b2ca17c7-b810-4e68-b7f4-0fc95edda9b4` is the password of the certificate, you can change it to any password you want.
